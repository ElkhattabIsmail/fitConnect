        ...
        <tbody>
            <?php foreach ($seances as $seance): ?>
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($seance->getIdSalle()); ?></td>
                    <td><?php echo htmlspecialchars($seance->getIdActivite() ?? '-'); ?></td>
                    <td><?php echo htmlspecialchars($seance->getIdEquipement() ?? '-'); ?></td>
                    <td>
